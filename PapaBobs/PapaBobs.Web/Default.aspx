<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PapaBobs.Web.Default" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div class="container">
        ...
        <asp:DropDownList ID="sizeDropDownList" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="recalculateTotalCost">
            <asp:ListItem Text="Please choose one ..." Value="" Selected="True" />
