...
namespace MegaChallengeCasino
{
...

    {
        ...
        {
            //bar returns zero, three 7's return 100, one or more cherries, return 2,3,4.

            if (isBar(reels)) return 0;
            if (isThreeSevens(reels)) return 100;
            int multiplier = 0;
        ...
        {
            multiplier = determineMultipliers(reels);
            if (multiplier > 0) return true;
            return false;

        }
        private int determineMultipliers(string[] reels)
        {
        ...
        private bool isThreeSevens(string[] reels)
        {
